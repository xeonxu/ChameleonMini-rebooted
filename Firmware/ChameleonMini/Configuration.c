...
static const MapEntryType ConfigurationMap[] PROGMEM = {
    ...
    { .Id = CONFIG_ULTRAMAN_Z_ACC_POS,	                  .Text = "ZETA_ACCESS_POS" },
    { .Id = CONFIG_ULTRAMAN_Z_ACC_NEG,	                  .Text = "ZETA_ACCESS_NEG" },
    { .Id = CONFIG_ULTRAMAN_Z_CHAR_POS,	                  .Text = "ZETA_CHARACTOR_POS" },
    { .Id = CONFIG_ULTRAMAN_Z_CHAR_NEG,	                  .Text = "ZETA_CHARACTOR_NEG" },
#endif
...
#endif
#ifdef CONFIG_ULTRAMAN_SUPPORT
[CONFIG_ULTRAMAN_Z_ACC_POS] = {
    .CodecInitFunc = ISO14443ACodecInit,
    .CodecTaskFunc = ISO14443ACodecTask,
    .ApplicationInitFunc = UltramanAppInit,
    .ApplicationResetFunc = NTAG21xAppReset,
    .ApplicationTaskFunc = ApplicationTaskDummy,
    .ApplicationTickFunc = ApplicationTickDummy,
    .ApplicationButtonFunc = Z_ACC_POS_ButtonFunc,
...
[CONFIG_ULTRAMAN_Z_ACC_NEG] = {
    ...
    .ApplicationTaskFunc = ApplicationTaskDummy,
    .ApplicationTickFunc = ApplicationTickDummy,
    .ApplicationButtonFunc = Z_ACC_NEG_ButtonFunc,
    .ApplicationProcessFunc = NTAG21xAppProcess,
    .ApplicationGetUidFunc = NTAG21xGetUid,
    .ApplicationSetUidFunc = NTAG21xSetUid,
    .ApplicationGetSakFunc = ApplicationGetSakDummy,
...
[CONFIG_ULTRAMAN_Z_CHAR_POS] = {
    ...
    .ApplicationTaskFunc = ApplicationTaskDummy,
    .ApplicationTickFunc = ApplicationTickDummy,
    .ApplicationButtonFunc = Z_CHAR_POS_ButtonFunc,
    .ApplicationProcessFunc = NTAG21xAppProcess,
    .ApplicationGetUidFunc = NTAG21xGetUid,
    .ApplicationSetUidFunc = NTAG21xSetUid,
    .ApplicationGetSakFunc = ApplicationGetSakDummy,
...
[CONFIG_ULTRAMAN_Z_CHAR_NEG] = {
    ...
    .ApplicationTaskFunc = ApplicationTaskDummy,
    .ApplicationTickFunc = ApplicationTickDummy,
    .ApplicationButtonFunc = Z_CHAR_NEG_ButtonFunc,
    .ApplicationProcessFunc = NTAG21xAppProcess,
    .ApplicationGetUidFunc = NTAG21xGetUid,
    .ApplicationSetUidFunc = NTAG21xSetUid,
    .ApplicationGetSakFunc = ApplicationGetSakDummy,
